        ...
        <div className="flex items-center gap-2">
          {isSignedIn === false && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-600/20 border border-indigo-500/30 text-xs text-indigo-300 hover:bg-indigo-600/30 transition-colors"
            >
              <LogIn size={12} />
              Sign in to save
            </button>
          ...
          {isSignedIn === true && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-indigo-600 to-violet-600 text-xs text-white font-medium hover:from-indigo-500 hover:to-violet-500 transition-all disabled:opacity-50"
            >
              {isSaving ? (
